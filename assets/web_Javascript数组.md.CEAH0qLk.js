...
<span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;">//forEach不改变原数组，也无返回值，只是把数组依个执行了一下</span></span></code></pre></div>`,5),t=[p];function h(k,e,r,g,d,E){return i(),a("div",{"data-pagefind-body":!0},t)}const c=s(l,[["render",h]]);export{A as __pageData,c as default};
