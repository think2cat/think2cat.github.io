...
<span class="line"><span>      }</span></span>
<span class="line"><span>    }</span></span>
<span class="line"><span>});</span></span></code></pre></div><p>取到数据后，不要急着去修改表格，因为此时表格可能还未完成渲染，可以通过<code>setTimeout</code>做延迟修改，也可通过<code>querySelector</code>判断表格是否渲染完成，从而再做修改表格的操作</p><p>操作表格就跟平时操作DOM一样，这里不再讲述，值得一提的是像React或Vue这种单页面系统，篡改猴的脚步一旦注入，是一直存在的，要注意变量的使用，在做路由跳转时才不会相互干扰</p>`,18),l=[i];function c(o,r,d,h,u,g){return n(),a("div",{"data-pagefind-body":!0},l)}const b=s(t,[["render",c]]);export{m as __pageData,b as default};
