import{_ as s,o as a,c as n,a7 as p}from"./chunks/framework.DHDObbvy.js";const i="/images/2026/model3.png",t="/images/2026/model3_bucket.png",e="/images/2026/model3_archive.png",l="/images/2026/model3_diff.png",y=JSON.parse('{"title":"借阅记录爆炸了，MongoDB 怎么办？MongoDB 数据建模进阶（二）","description":"","frontmatter":{"title":"借阅记录爆炸了，MongoDB 怎么办？MongoDB 数据建模进阶（二）","date":"2026-09-18T14:06:16.000Z","tags":["MongoDB"],"categories":["IT"]},"headers":[],"relativePath":"IT/借阅记录爆炸了，MongoDB 数据建模进阶（二）.md","filePath":"IT/借阅记录爆炸了，MongoDB 数据建模进阶（二）.md","lastUpdated":1790156412000}'),o={name:"IT/借阅记录爆炸了，MongoDB 数据建模进阶（二）.md"},h=p('<p><img src="'+i+'" alt=""></p><h1 id="借阅记录爆炸了-mongodb-怎么办-mongodb-数据建模进阶-二" tabindex="-1">借阅记录爆炸了，MongoDB 怎么办？MongoDB 数据建模进阶（二） <a class="header-anchor" href="#借阅记录爆炸了-mongodb-怎么办-mongodb-数据建模进阶-二" aria-label="Permalink to &quot;借阅记录爆炸了，MongoDB 怎么办？MongoDB 数据建模进阶（二）&quot;">​</a></h1><p>上一篇，我们解决了两个问题：</p><p><strong>一本书的数据太多怎么办？</strong></p><p>可以用 <strong>Subset Pattern</strong>，只把常用的数据放进主文档。</p><p><strong>少数数据特别大怎么办？</strong></p><p>可以用 <strong>Outlier Pattern</strong>，把特殊数据单独处理。</p><p>但如果问题再扩大一点呢？</p><p>图书馆每天都有几千、几万条借阅记录。</p><p>一个月几十万条，一年几百万条。</p><p>这时候麻烦的已经不是“一本书太大”，而是：</p><blockquote><p><strong>整个借阅记录库都在不断膨胀。</strong></p></blockquote><p>那这些数据应该怎么组织？</p><p><img src="'+t+`" alt=""></p><h2 id="一、借阅记录越来越多-能不能-分箱-保存" tabindex="-1">一、借阅记录越来越多，能不能“分箱”保存？ <a class="header-anchor" href="#一、借阅记录越来越多-能不能-分箱-保存" aria-label="Permalink to &quot;一、借阅记录越来越多，能不能“分箱”保存？&quot;">​</a></h2><p>想象一下，图书馆上线了一套新的借阅系统。</p><p>刚开始，每天只有几百条记录：</p><div class="language-text vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">text</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>9月15日：386 条</span></span>
